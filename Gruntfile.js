...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      ...
      pxVisSvgCanvas: {
        files: {
          'css/noprefix/px-vis-svg-canvas-sketch.css': 'sass/px-vis-svg-canvas-sketch.scss',
          'css/noprefix/px-vis-svg-canvas.css': 'sass/px-vis-svg-canvas-predix.scss',
        }
      },
      pxDemo: {
        files: {
      ...
      pxTooltipRegister: {
        files: {
          'css/noprefix/px-vis-tooltip-register-sketch.css': 'sass/px-vis-tooltip-register-sketch.scss',
